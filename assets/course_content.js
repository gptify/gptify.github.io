...
const COURSE_DATA = {
  "1_1": {
    ...
    "lessonNum": "1.1",
    "title": "1.1. LLM qanday fikrlaydi? (GPT vs Claude vs Gemini vs Fikrlovchi Reasoning Modellar)",
    "duration": "15 daqiqa",
    ...
    "storyboard": [
      ...
      {
        "tag": "3 / 4-QADAM: MODELLAR ARXITIPI",
        "avatar": "🎯",
        "name": "Qaysi Model Qachon Kerak?",
        "quote": "Frontier Flagmanlar (Claude Fable / GPT-6 Astra): B2B shartnomalar, analitika va universal ishchi kuch.\nDeep Reasoning (OpenAI o3 / DeepSeek-R1): Murakkab mantiq, audit va qiyin dasturlash.\nUlkan Kontekst (Gemini 3.8 Flash / 3.1 Pro): 1M-2M+ tokenlik qalin kitob va arxivlar.",
        "tip": "⚖️ <b>Evergreen Oltin Qoida:</b> Modelning vaqtinchalik versiya raqamiga emas, balki laboratoriya DNKsi va 4 ta arxetipiga qarab tanlang."
      },
      {
    ...
    "deepDive": "<div class=\"deep-dive-article\">\n  <div class=\"case-callout\">\n    <h4 style=\"color:var(--teal-light); margin-top:0;\">🎯 1-Qism: \"Next-Token Prediction\" Nima va Nega Model Inson Emas?</h4>\n    <p>\n      Ko'pchilik sun'iy intellektni xuddi Google kabi hamma narsani biluvchi internet-ensiklopediya deb o'ylaydi. Bu noto'g'ri! Katta Til Modellari (LLM — Large Language Models) aslida <b>navbatdagi eng ehtimolli tokenni (so'z yoki bo'g'inni) bashorat qiluvchi</b> ehtimollik kalkulyatoridir.\n    </p>\n    <p>\n      Masalan: <i>\"O'zbekistonning poytaxti — ...\"</i> jumlasi kiritilganda, model parametrlar bazasidan hisoblab, \"Toshkent\" so'zining ehtimolligi 99.4% deb topadi va uni chiqaradi. Agar siz modeldan u bilmaydigan noma'lum ichki hisobotingiz haqida so'rasangiz, u <i>\"bilmayman\"</i> deyish o'rniga, grammatik jihatdan eng ishonarli eshitiladigan <b>yolg'onni (hallucination)</b> to'qib chiqaradi.\n    </p>\n  </div>\n\n  <h4 style=\"color:var(--text); margin-top:20px;\">📊 2-Qism: Zamonaviy Modellarning 4 Ta Fundamental Arxetipi (Evergreen Tanlov Tizimi)</h4>\n  <p>\n    AI bozorida har 2-3 oyda yangi versiya raqamlari chiqadi. Doimiy ravishda qayta o'rganishdan qutulishning siri — <b>versiya raqamlarini emas, balki laboratoriyalarning o'zgarmas DNKsi va 4 ta asosiy arxetipini bilishdir:</b>\n  </p>\n\n  <div class=\"matrix-grid\">\n    <div class=\"matrix-col\" style=\"border-top:3px solid var(--brand-emerald);\">\n      <div style=\"font-size:10.5px; font-weight:800; color:var(--brand-emerald); text-transform:uppercase;\">1-Toifa: Frontier Generalists</div>\n      <b style=\"color:var(--text); font-size:13.5px;\">Anthropic Claude & OpenAI GPT Flagmanlari</b>\n      <div style=\"font-size:11px; color:var(--lime); margin-top:2px; font-weight:700;\">Eng so'nggi flagmanlar: Claude Fable 5.1 / GPT-6 Astra</div>\n      <p style=\"font-size:12px; color:var(--text-secondary); margin:6px 0 0 0; line-height:1.5;\">\n        <b>Laboratoriya DNKsi:</b> B2B hujjatlar, silliq va tabiiy rasmiy matnlar, marketing, kodlash va universal ko'p vazifalilik. Boshqaruvchi stolining universal tayanchi.\n      </p>\n    </div>\n    <div class=\"matrix-col\" style=\"border-top:3px solid #d97706;\">\n      <div style=\"font-size:10.5px; font-weight:800; color:#d97706; text-transform:uppercase;\">2-Toifa: Deep Reasoning (O'ylovchilar)</div>\n      <b style=\"color:var(--text); font-size:13.5px;\">OpenAI o-Series & DeepSeek-R Oilasi</b>\n      <div style=\"font-size:11px; color:#f59e0b; margin-top:2px; font-weight:700;\">Eng so'nggi flagmanlar: OpenAI o3 / o4 & DeepSeek-R1/R2</div>\n      <p style=\"font-size:12px; color:var(--text-secondary); margin:6px 0 0 0; line-height:1.5;\">\n        <b>Laboratoriya DNKsi:</b> Murakkab mantiq, chuqur moliyaviy audit va arxitektura. Javob berishdan oldin 5-30 soniya o'ylab (Chain-of-Thought), o'z xatosini o'zi tekshiradi.\n      </p>\n    </div>\n    <div class=\"matrix-col\" style=\"border-top:3px solid var(--tg-blue);\">\n      <div style=\"font-size:10.5px; font-weight:800; color:var(--tg-blue); text-transform:uppercase;\">3-Toifa: Ulkan Kontekst (Massive Context)</div>\n      <b style=\"color:var(--text); font-size:13.5px;\">Google Gemini Pro & Flash Oilasi</b>\n      <div style=\"font-size:11px; color:#38bdf8; margin-top:2px; font-weight:700;\">Eng so'nggi flagmanlar: Gemini 3.1 Pro & 3.8 Flash</div>\n      <p style=\"font-size:12px; color:var(--text-secondary); margin:6px 0 0 0; line-height:1.5;\">\n        <b>Laboratoriya DNKsi:</b> 1-2 million tokenlik xotira daryosi. 500-1000 betlik qalin kitoblar, yillik hisobotlar va butun video arxivlarini bir urinishda tahlil qilish.\n      </p>\n    </div>\n    <div class=\"matrix-col\" style=\"border-top:3px solid #8b5cf6;\">\n      <div style=\"font-size:10.5px; font-weight:800; color:#8b5cf6; text-transform:uppercase;\">4-Toifa: Ochiq & Tejamkor (Open-Weights)</div>\n      <b style=\"color:var(--text); font-size:13.5px;\">DeepSeek & Meta Llama Oilasi</b>\n      <div style=\"font-size:11px; color:#a78bfa; margin-top:2px; font-weight:700;\">Eng so'nggi flagmanlar: DeepSeek V4/V3 & Llama 4/3.3</div>\n      <p style=\"font-size:12px; color:var(--text-secondary); margin:6px 0 0 0; line-height:1.5;\">\n        <b>Laboratoriya DNKsi:</b> Korxonaning ichki maxfiy serverlarida mustaqil ishlatish (On-Premises / Ollama), 10-20 barobar tejamkorlik va ommaviy avtomatizatsiyalar.\n      </p>\n    </div>\n  </div>\n\n  <div style=\"margin-top:18px; background:rgba(255,255,255,0.03); border:1px solid var(--border); border-radius:14px; padding:16px;\">\n    <div style=\"display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:8px; margin-bottom:12px;\">\n      <div style=\"display:flex; align-items:center; gap:8px;\">\n        <span style=\"font-size:18px;\">🧭</span>\n        <b style=\"color:var(--text); font-size:13px;\">Interaktiv Model Maslahatchisi (Vazifangizni tanlang):</b>\n      </div>\n      <span style=\"font-size:11px; color:var(--lime); background:rgba(180,244,60,0.08); padding:2px 8px; border-radius:6px; font-weight:700;\">Evergreen Navigator</span>\n    </div>\n    <div style=\"display:flex; flex-wrap:wrap; gap:6px; margin-bottom:12px;\" id=\"modelPillContainer\">\n      <button type=\"button\" onclick=\"selectModelAdvisor('b2b', this)\" style=\"background:var(--brand-emerald); color:#fff; border:none; padding:6px 13px; border-radius:8px; font-size:11.5px; font-weight:700; cursor:pointer; transition:all 0.2s;\">📄 B2B Shartnoma & Hujjat</button>\n      <button type=\"button\" onclick=\"selectModelAdvisor('reasoning', this)\" style=\"background:rgba(255,255,255,0.06); color:var(--text-secondary); border:1px solid var(--border); padding:6px 13px; border-radius:8px; font-size:11.5px; font-weight:600; cursor:pointer; transition:all 0.2s;\">🧠 Chuqur Mantiq & Audit</button>\n      <button type=\"button\" onclick=\"selectModelAdvisor('massive', this)\" style=\"background:rgba(255,255,255,0.06); color:var(--text-secondary); border:1px solid var(--border); padding:6px 13px; border-radius:8px; font-size:11.5px; font-weight:600; cursor:pointer; transition:all 0.2s;\">📚 1000 Betlik Arxiv (1M+ token)</button>\n      <button type=\"button\" onclick=\"selectModelAdvisor('fast', this)\" style=\"background:rgba(255,255,255,0.06); color:var(--text-secondary); border:1px solid var(--border); padding:6px 13px; border-radius:8px; font-size:11.5px; font-weight:600; cursor:pointer; transition:all 0.2s;\">⚡ Tezkor Ishchi (Flash / Mini)</button>\n      <button type=\"button\" onclick=\"selectModelAdvisor('private', this)\" style=\"background:rgba(255,255,255,0.06); color:var(--text-secondary); border:1px solid var(--border); padding:6px 13px; border-radius:8px; font-size:11.5px; font-weight:600; cursor:pointer; transition:all 0.2s;\">🔒 Maxfiy Korxona Serveri</button>\n    </div>\n    <div id=\"modelAdvisorOutput\" style=\"background:rgba(0,0,0,0.25); border:1px solid rgba(255,255,255,0.06); border-radius:10px; padding:12px 14px; font-size:12.5px; color:var(--text-secondary); line-height:1.55;\">\n      <b style=\"color:var(--brand-emerald);\">Tavsiya: Anthropic Claude Oilasi (Claude Fable / Sonnet)</b><br>\n      B2B shartnomalar, rasmiy xatlar va nozik hisobotlar uchun Anthropic Claude tili eng tabiiy, professional va xatosiz ishlaydi. Halutsinatsiya xavfi minimal.\n    </div>\n  </div>\n\n  <div class=\"notes-box\" style=\"margin-top:16px; background:rgba(5, 150, 105, 0.05); border-left:3px solid var(--brand-emerald); padding:12px 14px;\">\n    <div style=\"display:flex; align-items:center; justify-content:space-between; margin-bottom:6px;\">\n      <b style=\"color:var(--brand-emerald); font-size:12.5px;\">🌐 Jonli Xalqaro Benchmark Radarlari (Doimiy 1-o'rinni tekshirish):</b>\n      <span style=\"font-size:10.5px; color:var(--text-muted);\">Real vaqtda yangilanadi</span>\n    </div>\n    <p style=\"font-size:12px; color:var(--text-secondary); margin:0 0 8px 0; line-height:1.55;\">\n      Kelajakda har qanday yangi model e'lon qilinganda, uning marketingiga emas, dunyo e'tirof etgan 2 ta mustaqil ochiq platformaga qarang:\n    </p>\n    <div style=\"display:grid; grid-template-columns:repeat(auto-fit, minmax(220px, 1fr)); gap:10px;\">\n      <a href=\"https://lmarena.ai\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"display:block; padding:10px 12px; background:rgba(255,255,255,0.04); border:1px solid var(--border); border-radius:10px; text-decoration:none; color:var(--text);\">\n        <div style=\"font-weight:700; font-size:12px; color:var(--teal-light);\">🏆 LMSYS Chatbot Arena (lmarena.ai)</div>\n        <div style=\"font-size:11px; color:var(--text-muted); margin-top:3px; line-height:1.4;\">Dunyo mutaxassislarining ko'r-ko'rona (blind Elo) baholash reytingi — bugunning mutlaq 1-raqamini ko'rsatadi.</div>\n      </a>\n      <a href=\"https://artificialanalysis.ai\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"display:block; padding:10px 12px; background:rgba(255,255,255,0.04); border:1px solid var(--border); border-radius:10px; text-decoration:none; color:var(--text);\">\n        <div style=\"font-weight:700; font-size:12px; color:var(--brand-emerald);\">⚡ Artificial Analysis (artificialanalysis.ai)</div>\n        <div style=\"font-size:11px; color:var(--text-muted); margin-top:3px; line-height:1.4;\">Modellarning tezligi (tok/sek), intellekt indeksi va narxi bo'yicha to'liq B2B qiyosiy xaritasi.</div>\n      </a>\n    </div>\n  </div>\n\n  <div class=\"case-callout\" style=\"border-left-color:var(--lime); margin-top:20px;\">\n    <h4 style=\"color:var(--brand-emerald); margin-top:0;\">🏢 3-Qism: Real Korxona Misoli (Halutsinatsiya Falokati)</h4>\n    <p>\n      Toshkentdagi ulgurji savdo korxonasi xodimi bepul chatga: <i>\"Yangi Soliq kodeksi bo'yicha keshbekka qanday chegirma beriladi?\"</i> deb ochiq savol berdi. Model O'zbekiston qonunida mavjud bo'lmagan soxta \"18-modda, 3-qism\"ni to'qib chiqardi. Natijada korxona shartnomada xato band kiritib, noqulay vaziyatga tushdi.\n    </p>\n    <p>\n      <b>To'g'ri GPTify Yondashuvi (Grounding):</b> Modelga hech qachon ochiq manbasiz savol bermang. Avval rasmiy hujjat matnini ko'chirib o'tkazing va buyruq bering: <i>\"Faqat quyidagi matn doirasida javob ber. Agar javob matnda bo'lmasa, 'Ushbu ma'lumot taqdim etilgan matnda yo'q' deb javob qaytar.\"</i>\n    </p>\n  </div>\n</div>",
    "quiz": {
    ...
    "notes": [
      ...
      "<b>4 Ta Fundamental Arxetip:</b> Generalist (Claude & GPT Flagmanlari), Reasoning (o-Series & DeepSeek-R), Ulkan Kontekst (Gemini Pro/Flash), Ochiq (DeepSeek & Llama).",
      "<b>Evergreen Tanlov Qoidasi:</b> Yangi versiya chiqqanda lmarena.ai va artificialanalysis.ai orqali toifasini aniqlang."
    ],
  ...
  "1_2": {
    ...
    "storyboard": [
      ...
      },
      {
        ...
        "tip": "💡 <b>AI Qoidasi:</b> Avval har bir bo'lim bo'yicha oraliq xulosa oling, so'ngra umumiy tahlil ishlab chiqing."
      },
      {
  ...
  "2_3": {
    ...
    "storyboard": [
      ...
      },
      {
        ...
        "tip": "📐 <b>Mantiq:</b> Model sizdan 3 ta savol so'raydi va siz uchun mukammal prompt ishlab chiqadi."
      },
      {
      ...
      },
      {
        ...
        "quote": "Ishlab chiqilgan mukammal promptlarni alohida hujjatga saqlab boring va har kuni ishlatishda vaqtingizni tejang.",
        "tip": "🏆 <b>Foyda:</b> 1 marta ishlab chiqilgan sifatli prompt yillab xizmat qiladi."
      }
    ],
    ...
    "quiz": {
      ...
      "correctIndex": 0,
      "explanation": "To'g'ri! Meta-prompting orqali sun'iy intellekt sizning xom g'oyangizni tahlil qilib, uning o'zi uchun eng tushunarli bo'lgan professional promptni ishlab beradi."
    },
    "notes": [
    ...
    "downloadablePrompt": "Sen professional Prompt Muhandisisan.\nMen senga o'z biznes vazifamni qisqacha aytaman.\nSen menga darhol javob yozma.\nAvval ushbu vazifa uchun mukammal prompt ishlab chiqishda kerak bo'ladigan 3 ta aniq savol ber (auditoriya, ohang va format bo'yicha).\nMen javob berganimdan keyin tayyor promptni chiqarib ber.",
    "homeworkTitle": "Topshiriq: Meta-prompt yordamida o'z ishingiz uchun 1 ta professional prompt ishlab chiqing",
  ...
  "3_1": {
    ...
    "storyboard": [
      ...
      },
      {
        ...
        "avatar": "⚔️",
        "name": "Asosiy Maydon:",
        "quote": "ChatGPT (GPT-6 / o-Series): Kundalik tezkor g'oyalar, tarjima, multimodal ovoz va agentlar.\nClaude (Fable / Sonnet): Murakkab B2B shartnomalar, analitika va tabiiy rasmiy hujjatlar.",
        "tip": "⚖️ <b>B2B Standarti:</b> Ish xatlari va shartnomalarda Claude tili jahon bo'yicha eng tabiiy va rasmiy hisoblanadi."
      },
      {
    ...
    "notes": [
      "<b>Claude Frontier (Fable / Sonnet):</b> Chuqur tahlil, B2B hujjatlar va gibrid mulohaza ustasi.",
      "<b>ChatGPT (GPT-6 & o-Series):</b> Ovozli muloqot, tezkor g'oyalar va multimodal avtonomlik.",
      "<b>Perplexity AI:</b> Jonli internet qidiruvi va manbalarga ega faktik tahlil."
    ],
  ...
  "3_2": {
    ...
    "storyboard": [
      ...
      },
      {
        ...
        "quote": "Bitta mavzu yoki matn asosida 30 soniyada professional dizaynli, rasmli va strukturali taqdimot ishlab beradi.",
    ...
    "quiz": {
      ...
      "correctIndex": 0,
      "explanation": "To'g'ri! Gamma App sun'iy intellekt yordamida bir zumda tayyor dizaynli va rasmli taqdimotlar ishlab beradi."
    },
    "notes": [
    ...
    "homeworkTitle": "Topshiriq: O'z loyihangiz bo'yicha Gamma App da 5 slayddan iborat taqdimot ishlab chiqing",
    "homeworkDefault": "Gamma App (yoki uning ssenariy prompti) yordamida o'z faoliyatingiz haqida 5 slaydlik mini-taqdimot ishlab chiqing va slayd sarlavhalarini shu yerga yozing."
  },
  "3_3": {
    "id": "3_3",
    "module": "3-Modul: Har Bir Vazifa Uchun To'g'ri Vosita",
  ...
  "4_2": {
    ...
    "storyboard": [
      ...
      },
      {
        ...
        "tip": "🏆 <b>Daromad:</b> Bir xil vaqt ichida 3 barobar ko'proq qiymat yetkazib berasiz."
      }
    ],
