...
const searchIndex = [
  ...
  { t: "Google DeepMind Shaxsiy Sun’iy Intellekt Uchun Xavfsiz Server Xotirasi Texnologiyasini Taqdim Etdi", u: "maqola.html?id=google-deepmind-private-ai-compute-secure-memory-2026", k: "google deepmind shaxsiy sun’iy intellekt uchun xavfsiz server xotirasi texnologiyasini taqdim etdi frontier ai tadqiqot google deepmind research google deepmind konfidentsial sun’iy intellekt hisoblashlari (private ai compute) uchun yangi appara" },
  { t: "Oracle Sun’iy Intellekt Infratuzilmasi Uchun 2.8 Mlrddan Ortiq Mablag‘ Yo‘naltirmoqda: An’anaviy Dasturchilar O‘rnini GPU va AI Muhandislari Egallamoqda", u: "maqola.html?id=oracle-ai-cloud-restructuring-layoffs-2026", k: "oracle sun’iy intellekt infratuzilmasi uchun 2.8 mlrddan ortiq mablag‘ yo‘naltirmoqda: an’anaviy dasturchilar o‘rnini gpu va ai muhandislari egallamoqda global biznes & ai cybernews & business insider oracle an’anaviy bulut va dasturiy ta’minot bo‘limlaridagi xodimlarni qisqartirib, bo‘shagan 2.8 mil" },
  { t: "O‘zbekiston Banklarida Sun’iy Intellekt Skoringi: 500 Mln So‘mgacha Kreditlarda Qog‘ozbozlik va Biznes-Reja Talabi Qanday Bekor Bo‘lmoqda?", u: "maqola.html?id=ozbekiston-fintex-kredit-skoring-ai-tahlil-2026", k: "o‘zbekiston banklarida sun’iy intellekt skoringi: 500 mln so‘mgacha kreditlarda qog‘ozbozlik va biznes-reja talabi qanday bekor bo‘lmoqda? o‘zbekiston fintech & ai spot.uz it & biznes tadbirkorlar uchun 500 million so‘mgacha kredit ajratishda an’anaviy biznes-reja majburiyati bekor q" },
  ...
  { t: "OpenAI rasman GPT-6 Sol va Luna modellarini e’lon qildi: 50% arzonlashgan API va yangi avlod tezligi", u: "maqola.html?id=openai-gpt6-sol-luna-50-percent-price-cut", k: "openai rasman gpt-6 sol va luna modellarini e’lon qildi: 50% arzonlashgan api va yangi avlod tezligi dunyo texnologiya openai research gpt-6 oilasi kengaydi: murakkab dasturlash vazifalari uchun sol hamda ultra-tezkor va ixcham luna mo" },
  { t: "xAI Grok 4.7 modelini taqdim etdi: Dasturlash va avtonom agentlar uchun 71% natija", u: "maqola.html?id=xai-grok-47-coding-benchmark-release", k: "xai grok 4.7 modelini taqdim etdi: dasturlash va avtonom agentlar uchun 71% natija dunyo texnologiya xai official elon muskning xai kompaniyasi dasturiy ta’minot injiniringi va professional tahlilga ixtisoslashgan " },
