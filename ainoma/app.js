...
const searchIndex = [
  ...
  { t: "Google Gemini 2.0 Flash va Multimodal Live API: 150ms jonli audio va video oqim", u: "maqola.html?id=gemini-2-flash", k: "google gemini 2.0 flash api audio video multimodal real-time call center live api" },
  ...
  { t: "OpenAI 'Operator' vositasini taqdim etdi: Brauzerda mustaqil ishlovchi AI agent", u: "maqola.html?id=openai-operator", k: "openai operator cua brauzer agent avtonom vazifa kompyuter" },
  { t: "OpenAI o1 to‘liq mantiqiy modeli: Rasmlar bilan fikrlash", u: "maqola.html?id=openai-o1", k: "openai o1 reasoning model chain of thought matematika dasturlash" },
