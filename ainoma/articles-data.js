window.AINOMA_ARTICLES = {
  "gemini-enterprise": {
    ...
    "deck": "Yangi arxitektura korxona call-markazlari va ilovalar uchun insondek tez muloqot qiluvchi ovozli yordamchilar va real vaqtda kamera tasvirini tahlil qilish imkoniyatini taqdim etdi.",
    ...
    "contentHtml": "\n<p>Google Cloud 2026-yil 21-sentabr kuni korporativ mijozlar uchun <strong>Gemini 2.5 Enterprise API</strong> arxitekturasini rasman taqdim etdi. Ushbu yangilanishning asosiy yutug‘i — ovoz va video signallarni atigi <strong>150 millisekundlik</strong> kechikish (latency) bilan ikki tomonlama to‘liq dupleks rejimida qayta ishlash imkoniyatidir.</p>\n\n<p>Ilgari AI ovozli yordamchilari foydalanuvchi so‘zini matnga o‘girib (STT), modelga yuborib, so‘ngra ovozga aylantirish (TTS) uchun 1.5–3 soniya vaqt sarflagan bo‘lsa, Gemini 2.5 mahalliy multimodal neyron tarmog‘i orqali to‘g‘ridan-to‘g‘ri audio to‘lqinlar bilan ishlaydi.</p>\n\n<h2>1. Korxonalar va Call-markazlar uchun nimalar o‘zgaradi?</h2>\n<p>B2B muloqotida inson pauzalarni va uzilishlarni darhol sezadi. 150ms ko‘rsatkichi insoniy tabiiy suhbat tezligiga to‘liq teng:</p>\n<ul>\n  <li><strong>Mijoz so‘zini bo‘lish:</strong> Mijoz gapirayotganda ovozli yordamchi uni eshitadi va gapini bo‘lib yangi savol bersa, darhol to‘xtab, yangi kontekstga moslashadi.</li>\n  <li><strong>Kamera tasvirini jonli ko‘rish:</strong> Mijoz nosoz uskunani yoki mahsulot shtrix-kodini smartfon kamerasida ko‘rsatganida, model ekranga qarab real vaqtda yo‘riqnoma beradi.</li>\n  <li><strong>Ko‘p tillilik va lahjalar:</strong> Tizim turli urg‘u va mintaqaviy tillarni murakkab akustik shovqinlar ostida ham 98.4% aniqlikda tushunadi.</li>\n</ul>\n\n<blockquote>\n  \"Gemini 2.5 Enterprise — bu shunchaki API emas, balki mijozlar bilan muloqot qiluvchi call-markaz operatorlari yuklamasini 70% ga qisqartiruvchi yangi avlod infratuzilmasidir.\"\n</blockquote>\n\n<h2>2. O‘zbekiston kompaniyalari uchun amaliy tavsiya</h2>\n<p>Agar sizda yetkazib berish xizmati, onlayn do‘kon, tibbiyot klinikasi yoki bank servisi bo‘lsa:</p>\n<ol style=\"padding-left:20px; line-height:1.8; margin-bottom:20px;\">\n  <li><strong>Birinchi navbatda FAQ va status tekshirishni avtomatlashtiring:</strong> Buyurtma holati, qarz qoldig‘i yoki manzilni aniqlash kabi 60% takrorlanuvchi qo‘ng‘iroqlarni AI ovozli agentiga topshiring.</li>\n  <li><strong>Gibrid marshrutlashni joriy qiling:</strong> Murakkab yoki e’tirozli holatlarda tizim avtomatik tarzda suhbat stenogrammasi bilan birga jonli operatorga ulasin.</li>\n</ol>\n\n<div class=\"article-note\">\n  <b>💡 Siz uchun xulosa:</b> API sinovlari allaqachon Google Cloud konsolida ochilgan. Dasturchilaringiz bilan birgalikda kichik sinov prototipini ishlab ko‘rishingiz tavsiya etiladi.\n</div>\n",
    "sources": [
      {
  ...
  "cbu-ai-skoring": {
    "title": "Markaziy Bank bank va fintexlarda AI skoringi qo‘llash bo‘yicha yangi reglamentni tasdiqladi",
    ...
    "img": "assets/registan.jpg",
    "imgAlt": "Markaziy Bank AI Skoring reglamenti",
    "readTime": "5 daqiqalik mutolaa",
    "author": "AiNoma Tahririyati",
    "authorRole": "O‘zbekiston huquqiy va fintex tahlili",
    "contentHtml": "\n<p>O‘zbekiston Respublikasi Markaziy Banki 2026-yil 20-sentabrda tijorat banklari, mikromoliya tashkilotlari va fintex kompaniyalarida sun’iy intellektga asoslangan skoring tizimlaridan foydalanish bo‘yicha yangi majburiy talablarni tasdiqladi.</p>\n\n<p>Mazkur hujjatning asosiy maqsadi — aholining kredit layoqatini baholashda noxolis qarorlar (algoritmik diskriminatsiya)ning oldini olish, fuqarolarning shaxsiy ma’lumotlari xavfsizligini kafolatlash va qaror qabul qilish mexanizmini shaffoflashtirishdan iboratdir.</p>\n\n<h2>1. Reglamentdagi 3 ta asosiy talab</h2>\n<ul>\n  <li><strong>Ma’lumotlarning lokalizatsiyasi:</strong> O‘zbekiston fuqarolarining biometrik, moliyaviy va shaxsiy ma’lumotlarini qayta ishlovchi barcha AI modellari va ma’lumotlar bazalari qat’iy ravishda O‘zbekiston Respublikasi hududida joylashgan serverlarda bo‘lishi shart. Xorijiy ochiq API servislarga mijoz ma’lumotlarini shifrlanmagan holda uzatish taqiqlanadi.</li>\n  <li><strong>Tushuntirib berish majburiyati (Explainable AI):</strong> Agar mijozga kredit berish rad etilsa, bank yoki fintex ilovasi umumiy javob bilan cheklanmasdan, qaysi aniq moliyaviy parametrlar (daromad yetarsizligi, muddati o‘tgan qarz, yuqori qarz yuki) sabab bo‘lganini ko‘rsatishi lozim.</li>\n  <li><strong>Algoritmik audit:</strong> Har bir moliya muassasasi har 6 oyda AI skoring modellarini diskriminatsiya va noto‘g‘ri ko‘rsatkichlar bo‘yicha mustaqil texnik auditdan o‘tkazadi.</li>\n</ul>\n\n<blockquote>\n  \"Sun’iy intellekt moliyaviy xizmatlarni tezlashtirishi kerak, ammo inson huquqlari va ma’lumotlar xavfsizligi hisobiga emas. Yangi reglament bozor ishtirokchilari uchun adolatli va qat’iy qoidalarni belgilaydi.\"\n</blockquote>\n\n<h2>2. Bank va mikromoliya kompaniyalari nimalarga e’tibor qaratishi kerak?</h2>\n<p>Ushbu reglamentga muvofiq, O‘zbekistondagi har bir moliya tashkiloti o‘zining skoring infratuzilmasini qayta ko‘rib chiqishi kerak:</p>\n<ol style=\"padding-left:20px; line-height:1.8; margin-bottom:20px;\">\n  <li>Ochiq xorijiy LLM modellariga mijozlarning passport yoki telefon raqamlarini to‘g‘ridan-to‘g‘ri yuborishni zudlik bilan to‘xtatish.</li>\n  <li>Lokal serverlarda ishlaydigan xususiy (on-premise yoki O‘zbekiston data-markazlaridagi) ochiq manbali modellardan (masalan, Llama yoki maxsus o‘qitilgan modellar) foydalanishga o‘tish.</li>\n  <li>Mijozlarga qaror sababini ko‘rsatuvchi interfeyslarni ilovalar va SMS xabarlarga kiritish.</li>\n</ol>\n\n<div class=\"article-note\">\n  <b>💡 Xulosa:</b> Bu qadam O‘zbekiston moliya bozorida professional va xavfsiz B2B AI yechimlariga talabni yanada oshiradi.\n</div>\n",
    "sources": [
      {
  ...
  "cursor-teamlead": {
    ...
    "contentHtml": "\n<p>Dasturlash muhitlarining yetakchisi <strong>Cursor</strong> hamda birinchi AI muhandisi Devin'ni yaratgan <strong>Cognition Labs</strong> hamkorlikda <strong>\"Autonomous Team Lead\"</strong> rejimini e’lon qildi. Bu yangilik dasturiy ta’minot ishlab chiqish jarayonida navbatdagi bosqichni boshlab berdi.</p>\n\n<p>Ilgari AI asistentlar shunchaki bitta fayl doirasida kod qatorini to‘ldirish yoki alohida funksiya yozish bilan cheklangan bo‘lsa, yangi rejim butun repozitoriy (repo-level) arxitekturasini tushunadi va o‘zini tajribali Team Lead kabi tutadi.</p>\n\n<h2>1. Yangi rejim nimalarni avtomatlashtiradi?</h2>\n<ul>\n  <li><strong>Multi-fayl refaktoring:</strong> Bazaviy ma’lumotlar bazasi sxemasi yoki API o‘zgarganda, agent tizimdagi barcha 50+ bog‘langan fayllarni, migratsiyalarni va frontend chaqiriqlarini bir vaqtda to‘g‘rilaydi.</li>\n  <li><strong>Avtomatik testlar va regressiya tekshiruvi:</strong> Kod yozilgach, agent orqa fonda virtual konteyner ko‘tarib, barcha testlarni yurgizadi va qayerda sinish yuz bersa, mustaqil ravishda tuzatadi.</li>\n  <li><strong>Pull Request va kod taqrizi:</strong> Inson dasturchilarga tayyor tahliliy tushuntirish, xavflar tahlili va benchmark natijalari bilan to‘liq PR taqdim etadi.</li>\n</ul>\n\n<blockquote>\n  \"Biz kod yozish davridan to‘liq arxitektura muhandisligi davriga o‘tdik. Endi muhandisning vazifasi sintaksis yozish emas, tizim talablari va biznes mantiqini to‘g‘ri shakllantirishdir.\"\n</blockquote>\n\n<h2>2. O‘zbekiston dasturchilari va IT kompaniyalari uchun tavsiyalar</h2>\n<ol style=\"padding-left:20px; line-height:1.8; margin-bottom:20px;\">\n  <li><strong>Test yozish madaniyatini kuchaytiring:</strong> Avtonom agentlar samarali ishlashi uchun loyihangizda testlar (unit/integration tests) va qat’iy CI/CD quvurlari bo‘lishi shart. Test bo‘lmasa, agent kodning to‘g‘riligini tekshira olmaydi.</li>\n  <li><strong>Modulli arxitekturani saqlang:</strong> Tartibsiz va bitta faylga yozilgan spagetti-kod AI uchun ham tahlil qilishga qimmatga tushadi.</li>\n</ol>\n",
    "sources": [
      {
  ...
  "itpark-yandex": {
    ...
    "imgAlt": "IT Park va Yandex AI Akademiyasi",
    "readTime": "4 daqiqalik mutolaa",
    "author": "AiNoma Tahririyati",
  ...
  "claude-37": {
    ...
    "contentHtml": "\n<p>Anthropic sun’iy intellekt laboratoriyasi o‘zining flagman <strong>Claude 3.7 Sonnet</strong> modelini taqdim etdi. Bu dunyodagi birinchi gibrid tafakkur (Hybrid Reasoning) arxitekturasiga ega tijoriy modeldir.</p>\n\n<h2>1. Gibrid tafakkur nima beradi?</h2>\n<p>Ilgari modellar yo faqat tezkor javob berar (standart LLM), yoki har bir savol ustida uzoq vaqt \"o‘ylab\" (o1 kabi reasoning modellar) javob qaytarar edi. Claude 3.7 da esa dasturchi model qancha vaqt fikrlashini <em>thinking_budget</em> parametri orqali nazorat qilishi mumkin.</p>\n<ul>\n  <li>Oddiy savollar uchun 1 soniyalik javob;</li>\n  <li>Murakkab xavfsizlik auditi, arxitektura loyihalash yoki matematik isbotlar uchun 30–60 soniyalik chuqur zanjirli tafakkur.</li>\n</ul>\n",
    "sources": [
      {
  ...
  "gov-ai-standards": {
    "title": "Raqamli Texnologiyalar Vazirligi davlat xizmatlarida AI qo‘llash bo‘yicha yangi standartlarni tasdiqladi",
    ...
    "img": "assets/registan.jpg",
    "imgAlt": "Davlat xizmatlarida AI standartlari",
    "readTime": "4 daqiqalik mutolaa",
    "author": "AiNoma Tahririyati",
  ...
  "mistral-pixtral": {
    "title": "Mistral AI \"Pixtral Large\" modelini chiqardi: Korxonalar uchun mustaqil multimodal AI",
  ...
  "itpark-gpu-grants": {
    "title": "IT Park AI startaplar uchun $5M GPU hisoblash grantlarini e’lon qildi",
  ...
  "tashkent-crm-voice": {
    "title": "Toshkentdagi distribyutorlar CRM tizimlariga AI ovozli yordamchilarni ulamoqda",
  ...
  "developer-ai-revolution": {
    "title": "Muhandislikda AI inqilobi: Dasturchilarning 45% dan ortig‘i agentlik muharrirlarga o‘tdi",
  ...
  "uzbekistan-retail-ai": {
    "title": "O‘zbekiston riteylida AI: Savdo konversiyasini 30% ga oshirish usullari",
